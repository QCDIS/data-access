...
OUTPUT_DIR = base_path + 'aws_s2_download_dir/'
...
def test_aws_s2_file_system_accessor_create_from_parameters():
    parameters = {'temp_dir': OUTPUT_DIR, 'path': base_path + 'aws_s2_data/', 'pattern': ''}
...
def test_aws_s2_file_system_get_parameters_as_dict():
    ...
    assert base_path + 'aws_s2_data/' == parameters_as_dict['path']
